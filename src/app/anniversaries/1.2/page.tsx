      ...
      <Card className="w-full max-w-3xl shadow-2xl overflow-hidden bg-card/80 backdrop-blur-sm">
        ...
        <CardContent className="p-8 space-y-6">
          <p className="text-lg text-foreground leading-relaxed">
            Un año y dos meses, mi amor. Parece que el tiempo vuela cuando estoy contigo. Cada día es una nueva oportunidad para amarte más y para construir juntos un futuro lleno de felicidad. Gracias por cada sonrisa, cada abrazo y cada momento. ¡Vamos por más!
          </p>
        </CardContent>
      </Card>
